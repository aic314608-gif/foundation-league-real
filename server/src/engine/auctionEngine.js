...
module.exports = { createAuctionState, placeBid, checkExpiry, autoFillRemaining, currentPlayer, startingBid, minIncrement, pauseAuction, resumeAuction, BID_WINDOW_MS };
