...
const {
  ...
  pauseAuction: pauseLot, resumeAuction: resumeLot,
...
module.exports = { startAuction, bid, pauseAuction, unpauseAuction, autoFillRest, getState, getStageAuctionStatus, resumeAuction };
