...
function minIncrement(currentBid) {
  if (currentBid < 3_000_000) return 150_000;
  if (currentBid < 10_000_000) return 500_000;
  if (currentBid < 30_000_000) return 1_000_000;
  return 2_500_000;
}
...
module.exports = { createAuctionState, placeBid, checkExpiry, autoFillRemaining, currentPlayer, startingBid, minIncrement, BID_WINDOW_MS };
